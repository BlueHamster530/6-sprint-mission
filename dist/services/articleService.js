...
class ArticleService {
    likeArticle(userId, articleId) {
        return __awaiter(this, void 0, void 0, function* () {
            const existingLike = yield articleLikeRepository_1.default.find(userId, articleId);
            if (existingLike) {
                yield articleLikeRepository_1.default.remove(existingLike.id);
                return { liked: false };
            }
            yield articleLikeRepository_1.default.create(userId, articleId);
            return { liked: true };
        });
    }
    ...
    getArticles(findOptions, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const articles = yield articleRepository_1.default.findAll(findOptions, userId);
